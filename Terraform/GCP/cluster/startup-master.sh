...
export K3S_DATASTORE_ENDPOINT="postgres://${db_username}:${db_password}@${db_host}:5432/k3s"
export K3S_TOKEN=${token}
file="/var/lib/rancher/k3s/server/tls/client-admin.crt"

# Function generate custom ca-certs
...
# Function install Cloud Controller Manager
